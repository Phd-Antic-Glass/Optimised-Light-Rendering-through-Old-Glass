...
class MTS_EXPORT_RENDER SpecularManifoldMultiScatter_AG /* : public Object */ {
public:
    ...
    SpecularManifoldMultiScatter_AG() {}
    ~SpecularManifoldMultiScatter_AG() {}
    ...
    Mask reproject(const SurfaceInteraction3f &si,Sampler *sampler);
