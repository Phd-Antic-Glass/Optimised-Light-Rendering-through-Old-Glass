...
class MTS_EXPORT_RENDER SpecularManifoldSingleScatter_AG {
public:
    ...
    SpecularManifoldSingleScatter_AG(const Scene *scene, const SMSConfig &config);
    ~SpecularManifoldSingleScatter_AG();
