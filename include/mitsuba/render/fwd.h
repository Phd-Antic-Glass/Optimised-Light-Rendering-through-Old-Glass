...
template <typename Float, typename Spectrum> class Heightfield;
...
template <typename Float_, typename Spectrum_> struct RenderAliases {
    ...
    using Heightfield = mitsuba::Heightfield<FloatU, SpectrumU>;
...
#define MTS_IMPORT_OBJECT_TYPES()                                                                  \
    ...
    using Heightfield = typename RenderAliases::Heightfield;
