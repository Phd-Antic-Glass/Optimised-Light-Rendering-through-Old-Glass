...
public:
    ...
    void generate_bicubic_coefs(ref<Texture> heightmap, Array<Float, 16> **coefs) {
        ...
        *coefs = new Array<Float, 16>[N * N];
		...
		Y = min(N - 3, max(1,Y));
                ...
                // C1
                Array<Float, 16> coef(
                    1.0F * F00, -1.83333333F * F00 + 3.0F * F01 - 1.5F * F02 + 0.333333333F * F03,
                    1.0F * F00 - 2.5F * F01 + 2.0F * F02 - 0.5F * F03, -0.166666667F * F00 + 0.5F * F01 - 0.5F * F02 + 0.166666667F * F03,
                    -1.83333333F * F00 + 3.0F * F10 - 1.5F * F20 + 0.333333333F * F30,
                    3.36111111F * F00 - 5.5F * F01 + 2.75F * F02 - 0.611111111F * F03 - 5.5F * F10 + 9.0F * F11 - 4.5F * F12 + 1.0F * F13 +
                        2.75F * F20 - 4.5F * F21 + 2.25F * F22 - 0.5F * F23 - 0.611111111F * F30 + 1.0F * F31 - 0.5F * F32 +
                        0.111111111F * F33,
                    -1.83333333F * F00 + 4.58333333F * F01 - 3.66666667F * F02 + 0.916666667F * F03 + 3.0F * F10 - 7.5F * F11 + 6.0F * F12 -
                        1.5F * F13 - 1.5F * F20 + 3.75F * F21 - 3.0F * F22 + 0.75F * F23 + 0.333333333F * F30 - 0.833333333F * F31 +
                        0.666666667F * F32 - 0.166666667F * F33,
                    0.305555556F * F00 - 0.916666667F * F01 + 0.916666667F * F02 - 0.305555556F * F03 - 0.5F * F10 + 1.5F * F11 -
                        1.5F * F12 + 0.5F * F13 + 0.25F * F20 - 0.75F * F21 + 0.75F * F22 - 0.25F * F23 - 0.0555555556F * F30 +
                        0.166666667F * F31 - 0.166666667F * F32 + 0.0555555556F * F33,
                    1.0F * F00 - 2.5F * F10 + 2.0F * F20 - 0.5F * F30,
                    -1.83333333F * F00 + 3.0F * F01 - 1.5F * F02 + 0.333333333F * F03 + 4.58333333F * F10 - 7.5F * F11 + 3.75F * F12 -
                        0.833333333F * F13 - 3.66666667F * F20 + 6.0F * F21 - 3.0F * F22 + 0.666666667F * F23 + 0.916666667F * F30 -
                        1.5F * F31 + 0.75F * F32 - 0.166666667F * F33,
                    1.0F * F00 - 2.5F * F01 + 2.0F * F02 - 0.5F * F03 - 2.5F * F10 + 6.25F * F11 - 5.0F * F12 + 1.25F * F13 + 2.0F * F20 -
                        5.0F * F21 + 4.0F * F22 - 1.0F * F23 - 0.5F * F30 + 1.25F * F31 - 1.0F * F32 + 0.25F * F33,
                    -0.166666667F * F00 + 0.5F * F01 - 0.5F * F02 + 0.166666667F * F03 + 0.416666667F * F10 - 1.25F * F11 + 1.25F * F12 -
                        0.416666667F * F13 - 0.333333333F * F20 + 1.0F * F21 - 1.0F * F22 + 0.333333333F * F23 + 0.0833333333F * F30 -
                        0.25F * F31 + 0.25F * F32 - 0.0833333333F * F33,
                    -0.166666667F * F00 + 0.5F * F10 - 0.5F * F20 + 0.166666667F * F30,
                    0.305555556F * F00 - 0.5F * F01 + 0.25F * F02 - 0.0555555556F * F03 - 0.916666667F * F10 + 1.5F * F11 - 0.75F * F12 +
                        0.166666667F * F13 + 0.916666667F * F20 - 1.5F * F21 + 0.75F * F22 - 0.166666667F * F23 - 0.305555556F * F30 +
                        0.5F * F31 - 0.25F * F32 + 0.0555555556F * F33,
                    -0.166666667F * F00 + 0.416666667F * F01 - 0.333333333F * F02 + 0.0833333333F * F03 + 0.5F * F10 - 1.25F * F11 +
                        1.0F * F12 - 0.25F * F13 - 0.5F * F20 + 1.25F * F21 - 1.0F * F22 + 0.25F * F23 + 0.166666667F * F30 -
                        0.416666667F * F31 + 0.333333333F * F32 - 0.0833333333F * F33,
                    0.0277777778F * F00 - 0.0833333333F * F01 + 0.0833333333F * F02 - 0.0277777778F * F03 - 0.0833333333F * F10 +
                        0.25F * F11 - 0.25F * F12 + 0.0833333333F * F13 + 0.0833333333F * F20 - 0.25F * F21 + 0.25F * F22 -
                        0.0833333333F * F23 - 0.0277777778F * F30 + 0.0833333333F * F31 - 0.0833333333F * F32 + 0.0277777778F * F33);
                // store everything:
	...
	Matrix<Float, 4> A(coefs[0], coefs[1], coefs[2], coefs[3], coefs[4], coefs[5], coefs[6], coefs[7], coefs[8], coefs[9], coefs[10],
	    coefs[11], coefs[12], coefs[13], coefs[14], coefs[15]);

	Array<Float, 4> A_t_vY = A * vY;
	Float f = -H * dot(vX, A_t_vY);
	if (full) {
	  Float du = -H * dx_scale * dot(Array<Float, 4>(0.f, 1.f, 2.f * dx, 3.f * d2x), A_t_vY);
	  Float dv = -H * dx_scale * dot(vX, A * Array<Float, 4>(0.f, 1.f, 2.f * dy, 3.f * d2y));
	  Float duu = -H * dx_scale_sqr * dot(Array<Float, 4>(0.f, 0.f, 2.f, 6.f * dx), A_t_vY);
	  Float dvv = -H * dx_scale_sqr * dot(vX, A * Array<Float, 4>(0.f, 0.f, 2.f, 6.f * dy));
	  Float duv =
	    -H * dx_scale_sqr * dot(Array<Float, 4>(0.f, 1.f, 2.f * dx, 3.f * d2x), A * Array<Float, 4>(0.f, 1.f, 2.f * dy, 3.f * d2y));
    ...
    Float bicubic(Point2f p, Mask active, int partial = 0) const {
        ...
        if (partial == 0) {
            ...
            std::cout << "error, Heighfield bicubic() <partial> " << partial << "is not a valid parameter" << std::endl;
            return 0;
        }
    ...
    Normal3f grad_h(Point2f P, Mask active) const {
        ...
        if (H != 0) {
            ...
            // return normalize(Normal3f(du_scale_sqr, df_du*du_scale, -df_dv*du_scale));
 ...
 /** \brief Ray-triangle intersection test
    ...
    std::pair<Mask, Float> ray_intersect(const Ray3f &ray_, Float *cache, Mask active) const override {
        ...
        if (H != 0) {
            ...
            auto [sucess_tri_1, tri1_u, tri1_v, tri1_t] = ray_intersect_triangle(ray, p0, p2, p3);
            if (sucess_tri_1) {
                cache[0] = tri1_t;
                return { true, tri1_t };
            }
            auto [sucess_tri_2, tri2_u, tri2_v, tri2_t] = ray_intersect_triangle(ray, p0, p3, p1);
            if (sucess_tri_2) {
                cache[0] = tri2_t;
                return { true, tri2_t };
            }
    ...
    void fill_surface_interaction(const Ray3f &ray_, const Float *cache, SurfaceInteraction3f &si_out, Mask active) const override {
        ...
        local         = Point3f(-H * bicubic(Point2f(local.y() * invL, local.z() * invW), active, 0), local.y(), local.z());
        ...
        Normal3f dp_du = m_to_world * Normal3f(-H *N* bicubic(si.uv, active, 1), N*du_scale, 0);
        Normal3f dp_dv = m_to_world * Normal3f(-H *N* bicubic(si.uv, active, 2), 0, N*du_scale);
        si.dp_du       = dp_du;
        si.dp_dv       = dp_dv;
    ...
    SurfaceInteraction3f eval_surfaceInteraction_from_uv(Point2f p, Mask active, SurfaceInteraction3f &si_) const override {
        MTS_MASK_ARGUMENT(active);
        SurfaceInteraction3f si;
        ...
        si.n                = m_to_world * normalize(flip * grad_local);
        si.dp_du            = m_to_world * Normal3f(-H *N* bicubic(p, active, 1),N* du_scale, 0);
        si.dp_dv            = m_to_world * Normal3f(-H *N* bicubic(p, active, 2), 0,N* du_scale);
        si.uv               = p;
    ...
    Array<Float, 6> eval_curvature_du(Point2f p, Mask active, bool full) const {
        ...
        Float du = -H * dot(Array<Float, 4>(0.f, 1.f, 2 * dx, 3.f * d2x), A * vY);
        Float dv = -H * dot(vX, A * Array<Float, 4>(0.f, 1.f, 2 * dy, 3.f * d2y));

        Float duu = -H * dot(Array<Float, 4>(0.f, 0.f, 2.f, 6.f * dx), A * vY);
        Float dvv = -H * dot(vX, A * Array<Float, 4>(0.f, 0.f, 2.f, 6.f * dy));
        Float duv = -H * dot(Array<Float, 4>(0.f, 1.f, 2.f * dx, 3.f * d2x), A * Array<Float, 4>(0.f, 1.f, 2.f * dy, 3.f * d2y));
    ...
    std::pair<Vector3f, Vector3f> normal_derivative(const SurfaceInteraction3f &si, bool /*shading_frame*/, Mask active) const override {
        ...
        if (H != 0) {
            ...
            dn_du               = (((f * F - e * G) * inv_EGtimesFF * (V_du)) + ((e * F - f * E) * inv_EGtimesFF * (V_dv)));
            dn_dv               = (((g * F - f * G) * inv_EGtimesFF * (V_du)) + ((f * F - g * E) * inv_EGtimesFF * (V_dv)));
...
private:
    ...
    Float dx_scale, dy_scale, dx_scale_sqr, dy_scale_sqr, du_scale, dv_scale, du_scale_sqr;
