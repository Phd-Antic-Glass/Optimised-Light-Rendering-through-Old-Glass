...
SpecularManifoldMultiScatter<Float, Spectrum>::newton_solver(const SurfaceInteraction3f &si,
    ...
    while (iterations < m_config.max_iterations) {
        ...
        iterations++;
        // std::cout << "iteration " << iterations << "size " <<  m_current_path.size() << std::endl;

        // std::cout << m_current_path[0].to_string() << std::endl;
        // std::cout << m_current_path[1].to_string() << std::endl;
    }
