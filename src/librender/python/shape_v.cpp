...
MTS_PY_EXPORT(Shape) {
    ...
    MTS_PY_CLASS(Shape, Object)
        ...
        .def_method(Shape, is_glinty)
        .def_method(Shape, is_caustic_receiver)
        .def_method(Shape, is_caustic_caster_single_scatter)
        .def_method(Shape, is_caustic_caster_multi_scatter)
        .def_method(Shape, is_caustic_bouncer)
