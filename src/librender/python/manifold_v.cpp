...
MTS_PY_EXPORT(SpecularManifoldMultiScatter) {
    MTS_PY_IMPORT_TYPES()
    using SpecularManifoldMultiScatter = SpecularManifoldMultiScatter<Float, Spectrum>;

    MTS_PY_STRUCT(SpecularManifoldMultiScatter)
        .def(py::init<>())
        .def("init", &SpecularManifoldMultiScatter::init, "scene"_a, "config"_a)
        .def("specular_manifold_sampling", &SpecularManifoldMultiScatter::specular_manifold_sampling,
             "si"_a, "sampler"_a)
        .def("sample_path", &SpecularManifoldMultiScatter::sample_path,
            "shape"_a, "si"_a, "ei"_a, "sampler"_a,
            "first_path"_a, "p_start"_a=Point3f(0.f))
        .def("current_path", &SpecularManifoldMultiScatter::current_path)
        .def("newton_solver", &SpecularManifoldMultiScatter::newton_solver,
             "si"_a, "ei"_a)
        .def("compute_step_halfvector", &SpecularManifoldMultiScatter::compute_step_halfvector,
            "v0p"_a, "v2"_a)
        .def("compute_step_anglediff", &SpecularManifoldMultiScatter::compute_step_anglediff,
            "v0p"_a, "v2"_a);
}
